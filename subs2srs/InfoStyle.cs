...
{
  /// <summary>
  /// Lightweight cross-platform replacement for System.Drawing.Font.
  /// </summary>
  public class FontInfo
  {
    ...
    public FontInfo(string name, float size, bool bold = false, bool italic = false,
  ...
  {
    private FontInfo font = new FontInfo("Arial", 20);

    private SrsColor colorPrimary = SrsColor.White;
    private SrsColor colorSecondary = SrsColor.Red;
    private SrsColor colorOutline = SrsColor.Black;
    private SrsColor colorShadow = SrsColor.Black;
